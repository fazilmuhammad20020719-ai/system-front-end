    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200/60 overflow-hidden">
            ...
            <div className="grid grid-cols-12 bg-[#f8fafc] p-4 border-b border-gray-200 text-[10px] font-bold text-gray-500 uppercase tracking-wider min-w-[600px]">
                ...
                <div className="col-span-4">Program Info</div>
            ...
            <div className="divide-y divide-gray-100 overflow-x-auto max-h-[65vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
                <div className="min-w-[600px]">
                    {students.length > 0 ? students.map((student) => {
                        // Parse enrollments
                        let enrollments = student.enrollments_summary || [];
                            ...
                            <div key={student.id} className="grid grid-cols-12 p-3 items-center hover:bg-gray-50 transition-colors group">
                                ...
                                <div className="col-span-4 flex flex-wrap gap-1">
                                    {enrollments.map((enr, idx) => (
                                        <span key={idx} className="inline-block bg-[#f3f4f6] text-gray-500 text-[10px] px-2 py-0.5 rounded font-medium border border-gray-200 whitespace-nowrap">
                                            {enr.program} {enr.year || enr.currentYear}
                                        </span>
                                    ))}
                                </div>
